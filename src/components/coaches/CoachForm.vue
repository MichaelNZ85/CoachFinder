<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid: !firstName.isValid}">
      ...
      <p v-if="!lastName.isValid" :class="invalid">Surname must not be empty.</p>
    </div>
    <div class="form-control" :class="{invalid: !firstName.isValid}">
    ...
    <div class="form-control" :class="{invalid: !firstName.isValid}">
      ...
      <p v-if="!rate.isValid" :class="invalid">Hourly rate must be more than zero.</p>
    </div>
    <div class="form-control" :class="{invalid: !firstName.isValid}">
      <h3>Areas of Expurrtise</h3>
      <div>
      ...
      <p v-if="!areas.isValid" :class="invalid">At least one area of expurrtise must be selected</p>
    </div>
